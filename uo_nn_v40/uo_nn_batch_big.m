...
icg = 1; irc = 2 ; nu = 1.0;                                  % Search direction.
sg_seed = 123456; sg_al0 = 2; sg_be = 0.3; sg_ga = 0.01;      % SGM iteration.
sg_emax = kmax; sg_ebest = floor(0.01*sg_emax);               % SGM stopping condition.
%
% Optimization
%
global iheader; iheader = 1;
csvfile = strcat('uo_nn_batch_big',num2str(tr_seed),'-',num2str(te_seed),'.csv');
