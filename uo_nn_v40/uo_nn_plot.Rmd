...
All of the methods tried, however, identify a stationary solution for the loss function that provides a weight vector $w$ which allow to perform the task at hand with sufficient accuracy.
