...
First, we plot CPU time with respect to model formulation, primal and dual, on a bigger dataset, where the variation can be noticeable.
...
We now plot CPU time of the dual formulation with respect to 
