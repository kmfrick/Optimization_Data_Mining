...
To represent the grains we use the properties length (4) and width (5). On Figure \@ref(plot-grains) we see some example grains of the dataset.

```{r plot-grains, fig.cap="Example grains"}
