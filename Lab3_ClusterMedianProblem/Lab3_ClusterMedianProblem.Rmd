...
We have also shown that **accuracy is not improved if the dimensionality of the dataset is reduced**.
If clusters are clearly separated and don't overlap, the result is the same as the optimal solution.
